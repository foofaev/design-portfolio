...
const saveProjectImageSuccess: ActionFunction2<number, Buffer> = ({ ord, data }) => ({ type: 'PROJECT_IMAGE_SAVE_SUCCESS', payload: { ord, data } });
const saveProjectImageFailure: ActionFunction0 = () => ({ type: 'PROJECT_IMAGE_SAVE_FAILURE', payload: {} });

/* ****************************************************************************************************************** */
const updateProjectImageOrdRequest: ActionFunction0 = () => ({ type: 'PROJECT_IMAGE_ORD_UPDATE_REQUEST', payload: {} });
const updateProjectImageOrdSuccess: ActionFunction1<number> = ({ ord }) => ({ type: 'PROJECT_IMAGE_ORD_UPDATE_SUCCESS', payload: { ord } });
...
const removeProjectImageSuccess: ActionFunction1<Project> = ({ project }) => ({ type: 'PROJECT_IMAGE_REMOVE_SUCCESS', payload: { project } });
